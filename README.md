# Artificial-Intelligence-Resolution-Inference-Algorithm
Program to check if query is entailed by Knowledge Base

Artificial Intelligence HW3 USC - CSCI561 - FALL 2016
...
Refer the hw3-csci561-f16.pdf for more details
